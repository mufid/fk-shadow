...
public class EnemyManager
{
    ...
    public void processEvent( ScannedRobotEvent scanned, Point2D enemyLocation )
    {
        ...
        {
            //System.out.println( "EXISTING Enemy: " + scanned.getName() );
            enemy = ( Enemy ) this.enemyMap.get( scanned.getName() );
            enemy.updateData( scanned, enemyLocation );
            System.out.println("Got " + enemy.getName() + " avgloc: " + enemy.getAverageLocation());
        }
        else
        {
        	//System.out.println( "NEW Enemy: " + scanned.getName() );
